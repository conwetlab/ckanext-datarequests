...
class AuthTest(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        (auth.update_datarequest_comment, constants.SHOW_DATAREQUEST_COMMENT, 'user_id', {'id': 'id',
                                                                                          'user_id': 'other_user_id'}, True, False),
        (auth.update_datarequest_comment, constants.SHOW_DATAREQUEST_COMMENT, 'user_id', {'id': 'id',
                                                                                          'user_id': 'other_user_id'}, False, False),
        ...
        (auth.delete_datarequest_comment, constants.SHOW_DATAREQUEST_COMMENT, 'user_id', {'id': 'id',
                                                                                          'user_id': 'other_user_id'}, True, False),
        (auth.delete_datarequest_comment, constants.SHOW_DATAREQUEST_COMMENT, 'user_id', {'id': 'id',
                                                                                          'user_id': 'other_user_id'}, False, False),
